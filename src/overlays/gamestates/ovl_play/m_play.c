...
void Game_play_change_scene_move_end(Game_Play* game_play) {
    ...
    common_data.unk_10004 = common_data.save.flash.sceneNo;
    common_data.save.flash.sceneNo = game_play->unk_1E18;
}
...
void play_init(Game* game) {
    ...
    func_8006C8D0_jp();
    game_play->unk_1DAC = -1;
    Gameplay_Scene_Read(game_play, common_data.save.flash.sceneNo);
...
void Gameplay_Scene_Read(Game_Play* game_play, s16 arg1) {
    ...
    sAdo_RoomType(mPl_SceneNo2SoundRoomType(common_data.save.flash.sceneNo));
}
